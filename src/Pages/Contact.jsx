...
function Contact(){
    return(
        <Layout>
             <>
            <section className="text-indigo-200 body-font bg-gradient-to-r from-blue-400 to-purple-400">
                ...
                <div className="hidden pr-0 lg:w-3/5 md:w-1/2 md:pr-16 lg:pr-0 md:block">
                    ...
                    <form className="bg-gradient-to-r from-blue-800 to-purple-800 flex flex-col w-full p-8 mt-10 bg-gray-100 rounded-lg lg:w-2/6 md:w-1/2 md:ml-auto md:mt-0">
                        <h2 className="mb-5 text-4xl font-medium text-indigo-200 title-font md:">Please Fill in the Details</h2>

                        <p className="pb-6">and we will contact you</p>

                        <div className="relative mb-4">
                            <label htmlFor="firstName" className="text-sm leading-7 text-indigo-300">Name</label>
                            <input 
                                type="text" 
                                id="firstName" 
                                name="firstName" 
                        ...
                        <div className="relative mb-4">
                            <label htmlFor="email" className="text-sm leading-7 text-indigo-300">Email <span className="text-red-500">*</span></label>
                            <input 
                                type="email" 
                                id="email" 
                                name="email" 
                        ...
                        <div className="relative mb-4">
                            <label htmlFor="mobileNumber" className="text-sm leading-7 text-indigo-300">Mobile Number <span className="text-red-500">*</span></label>
                            <input 
                                type="tel" 
                                id="mobileNumber" 
                                name="mobileNumber" 
                        ...
                        <button 
                            className="w-full px-8 py-2 text-lg text-white bg-gradient-to-r from-blue-600 to-purple-600 border-0 rounded focus:outline-none hover:from-blue-400 hover:to-purple-400">
                            Submit
                        </button>
